...
const GlassContainer = ({ children, className = "" }: GlassContainerProps) => {
  return (
    <div className="relative w-full overflow-hidden">
      {/* Background blobs */}
      <div className="absolute w-64 h-64 bg-blue-300 rounded-full left-[10%] bottom-[-3rem] blur-2xl -z-10" />
      <div className="absolute w-32 h-32 bg-pink-300 rounded-full right-[5%] top-[25%] blur-2xl -z-10" />
      <div className="absolute w-28 h-28 bg-orange-300 rounded-full left-[5rem] top-[5rem] blur-2xl -z-10" />
